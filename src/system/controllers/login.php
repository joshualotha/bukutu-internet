...
// Buku Tu Internet: Redirect visitors to buy page
// Only redirect if no explicit route (direct visit to homepage)
if (!isset($_GET['_route']) && !User::getID()) {
    header('Location: ' . APP_URL . '/buy.php');
    exit;
}
